...
// Type definitions
export type AppointmentStatus = 'confirmed' | 'payment_held' | 'cancelled' | 'completed';
...
const dummyAppointments: Appointment[] = [
  {
    ...
    time: '9:00 AM',
    status: 'confirmed',
    imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAkQtzYhe_p7fu9laB6M8HHcpbwu50tcLcOG7v2znOdUP9VB8QdYUT82DvVA6N4gw2AcWrrKdMrkuXgHdTVzLQqfFoscLRss1rcRREVBaOLSOmKXGgCh7iGxm3vH0aT06Ml6zUW4UJYDwyv4Yg98IQbTqASb-beIkoVQCnYUPESoUltCAQamPSzIxZUvQYZuGv4iP84d8qW9TsjS7_XMxnlLoOhUUzTS5uODvJYV7BYlrcEsxJZRGJ_iO0G9a2bLgsS6JfYps_wzOI2',
  ...
  },
  {
    ...
    time: '2:00 PM',
    status: 'payment_held',
    imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB7IHuQa381LVtn3coSFAPKHRSf6LHp6HNmqMKesoByan8JzW4cqfgFRKFC5M4aWjAPI3xf8YcjA0PT-J2DtVZwLZyQPqIXyKtCVQAj-2-9Qx40uyZpms2S-wLHJyIgi3pPmc71cbTr22R7rKuqiGAFiCn2vwcRpIyb7HTJXqZMyJMZVfBlkjgP2b_UdrREG0bI4YLFEM0ImrUdguKQYMYtHpobanI1V9eO0GiUrqxs0q8PWO0m_q-n6pcLru-f2HeZMj7tMz-NzYU0',
...
const statusConfig: Record<AppointmentStatus, { label: string; bgColor: string; textColor: string; borderColor: string }> = {
  confirmed: {
    label: 'Confirmed',
      ...
      <div className="flex flex-col gap-6">
            ...
            >
              <div className="flex flex-col md:flex-row justify-between gap-6">
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2 mb-1">
                      <h2 className="text-xl font-bold text-primary">{appointment.serviceName}</h2>
                ...
                <div className="flex flex-col items-start md:items-end gap-4">
                  <span className={`${status.bgColor} ${status.textColor} px-4 py-1 rounded-full font-semibold text-xs border ${status.borderColor}`}>
                    {status.label}
                  </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-surface/50 rounded-xl p-8 border-2 border-dashed border-outline-variant flex flex-col items-center justify-center text-center">
            ...
            <h4 className="text-base font-bold text-on-surface-variant">Need another service?</h4>
            <p className="text-sm text-on-surface-variant mb-4">Discover top-rated professionals in your area.</p>
          ...
          <div className="bg-primary p-8 rounded-xl text-white flex flex-col justify-between">
            <div>
              ...
              <p className="opacity-80 text-base">
                You have saved $45 in booking fees this month with your Appointly Gold membership.
              </p>
            </div>
