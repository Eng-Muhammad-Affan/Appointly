        ...
        <div className="max-w-md mx-auto p-4">
            ...
            required
                ...
                components={{
                    ...
                    DayButton: (props) => {
                        ...
                        let className = "h-10 w-10 flex items-center justify-center rounded-lg mx-auto transition-colors";

                        if (modifiers.selected) {
                            className += " bg-secondary/20 font-bold border border-secondary/30 text-black";
                        } else if (modifiers.today) {
                            className += "bg-surface-container-low rounded-full text-accent font-bold";
                        } else if (isOutside) {
                ...
                classNames={{
                    ...
                    nav: "flex gap-2",
                    weekdays: "grid grid-cols-7 text-center text-xs font-semibold text-gray-500 mb-2",
                    weekday: "block",
                    weeks: "grid grid-cols-7 gap-1 text-center text-sm",
                    week: "contents",
                    day: "block p-0 relative",
                    selected: "bg-secondary rounded-md font-bold border border-secondary/30 text-black",
            ...
            {selected && (
                <div className="mt-4 p-3 bg-gray-50 rounded-lg text-center text-sm">
                    Selected: {selected.toLocaleDateString('default', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
