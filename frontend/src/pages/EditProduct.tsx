          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8 grid grid-cols-2 gap-x-10 max-xl:grid-cols-1 max-xl:gap-y-10">
              ...
              <div className="mt-4 flex flex-col gap-5">
                ...
                <InputWithLabel label="Category">
                  <SelectInput
                    ...
                    value={productDetails.category_slug && productDetails.category_slug || ""}
                    // onChange={(e) =>
                    //   setInputObject({
                    //     ...inputObject,
            ...
            <div>
              ...
              <div className="flex justify-center gap-x-2 mt-5 flex-wrap">
                {productDetails.productImages.map((imgs, idx) => (
                  <img src={imgs.imageFile} alt="" className="w-36 h-32" key={idx} />
                ))}
              </div>
            </div>
          </div>
