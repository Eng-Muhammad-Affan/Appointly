...
const ProductTable = () => {
  ...
  return (
    <div className="w-full overflow-x-auto">
      <table className="mt-6 w-full whitespace-nowrap text-left"> {/* Remove max-lg classes */}
        <colgroup>
            ...
            <tr key={nanoid()}>
              <td className="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                <div className="flex items-center gap-x-4">
                  <img
                    src={item.productImages[0].thumbnailFile}
                    alt=""
              ...
              <td className="py-4 pl-0 pr-4 text-sm leading-6 sm:pr-8 lg:pr-20">
                <div className="flex items-center gap-x-2 justify-start">
                  <div
                    className={
                      item.stockStatus === "instock" ? inStockClass : outOfStockClass
                    }
                  >
              ...
              <td className="py-4 text-blue-main pl-0 pr-8 text-sm leading-6 font-medium table-cell lg:pr-20">
                RS {item.price}
              </td>
